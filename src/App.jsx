        ...
        <div onClick={()=>setOpen(true)} style={{cursor:"pointer",userSelect:"none",display:"flex",alignItems:"center",justifyContent:"center"}}>
          <svg width={msz} height={msz} style={{overflow:"visible",filter:"drop-shadow(0 0 16px #EF535055)",transition:"filter 0.3s ease"}}>
            ...
            <g clipPath="url(#scoreMiniClip)">
              ...
              {/* Smoke orbs — one per corner, all shooting toward center */}
              <circle cx={mcx-40} cy={mcy+40} r={26} fill="#EF5350" opacity={0.6} filter="url(#orbBlobMini)" style={{mixBlendMode:"screen"}} className="score-orb-mini-1"/>
              <circle cx={mcx+40} cy={mcy+40} r={26} fill="#EF5350" opacity={0.6} filter="url(#orbBlobMini)" style={{mixBlendMode:"screen"}} className="score-orb-mini-2"/>
              <circle cx={mcx-40} cy={mcy-40} r={26} fill="#EF5350" opacity={0.6} filter="url(#orbBlobMini)" style={{mixBlendMode:"screen"}} className="score-orb-mini-3"/>
              <circle cx={mcx+40} cy={mcy-40} r={26} fill="#EF5350" opacity={0.6} filter="url(#orbBlobMini)" style={{mixBlendMode:"screen"}} className="score-orb-mini-4"/>
            </g>
            {/* Outer ring */}
  ...
  return(
    <div style={{padding:"16px",paddingTop:isMobile?"0":"0",paddingBottom:"80px",display:"flex",flexDirection:"column",gap:20}}>
      ...
      {statOpen==="mail"&&token&&(
        ...
        <div style={{maxWidth:640,width:"100%"}}><DailySheetCard authToken={authToken}/></div>
