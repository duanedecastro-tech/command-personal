      ...
      <div onClick={()=>setOpen(true)} style={{cursor:"pointer",display:"flex",flexDirection:"column",alignItems:"center",flexShrink:0,userSelect:"none"}}
        ...
        <svg width={sz} height={sz} style={{overflow:"visible",filter:`drop-shadow(0 0 20px ${scoreColor}33)`,transition:"filter 0.3s ease"}}>
          ...
          <g clipPath="url(#scoreClip)">
            ...
            <circle cx={90} cy={95} r={26} fill="#3B5BDB" opacity={0.62} filter="url(#orbBlob)" className="score-orb-1"/>
            <circle cx={140} cy={88} r={26} fill="#F59E0B" opacity={0.62} filter="url(#orbBlob)" className="score-orb-2"/>
            <circle cx={100} cy={142} r={26} fill="#43A047" opacity={0.62} filter="url(#orbBlob)" className="score-orb-3"/>
            <circle cx={138} cy={140} r={26} fill="#AB47BC" opacity={0.62} filter="url(#orbBlob)" className="score-orb-4"/>
          </g>
